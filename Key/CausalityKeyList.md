...
| Kind Value | Event Name         | Purpose                                  | Key Tags Structure                                                                                                                                                       |
| ---------- | ------------------ | ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 30800      | Direct Intent Task | Publish a direct task intent             | ["auth", "d":"subspace_op", "op":"flux_task_publish_direct", "sid", "power_cost", "reward", "deadline", "category", "difficulty", "p"]                                   |
| 30801      | Causal Graph Task  | Publish a task describing a causal graph | ["auth", "d":"subspace_op", "op":"flux_task_publish_causal", "sid", "power_cost", "graph", "e", "p"]                                                                     |
| 30802      | Single Event Task  | Publish a task targeting a single event  | ["auth", "d":"subspace_op", "op":"flux_task_publish_single", "sid", "power_cost", "reward", "deadline", "category", "difficulty", "e", "p", "input_type", "output_type"] |
| 30803      | Task Response      | Submit a response/solution to a task     | ["auth", "d":"subspace_op", "op":"flux_task_response", "sid", "e", "p", "status", "power_cost", "quality_score"]                                                         |
| 30804      | Task Evaluation    | Evaluate a submitted response            | ["auth", "d":"subspace_op", "op":"flux_task_evaluation", "sid", "e", "re", "p", "score", "status", "power_cost"]                                                         |

### Decentralized Inference Protocol (CIP 09)

| Kind Value | Event Name                 | Purpose                                                             | Key Tags Structure                                                                                                                                                    |
| ---------- | -------------------------- | ------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 30900      | Decentralized Task Publish | Publish an encrypted inference task intent into the Prakasa network | ["auth", "d":"subspace_op", "sid", "op":"dinf_task_publish", "power_cost", "reward", "deadline", "category", "difficulty", "p", "rules"]                              |
| 30901      | Scheduler Assignment       | Scheduler announces intra-model partitioning and worker assignment  | ["auth", "d":"subspace_op", "sid", "op":"dinf_task_assign", "e", "p", "model_name", "model_version", "pipeline_id", "allocation_id"]                                  |
| 30902      | Worker Result / Response   | Worker publishes computed outputs and execution metadata            | ["auth", "d":"subspace_op", "sid", "op":"dinf_task_result", "e", "re", "p", "account", "status", "start_layer", "end_layer", "tokens_in", "tokens_out", "latency_ms"] |
| 30903      | Workload Proof             | Worker publishes signed, content-addressed proof of computation     | ["auth", "d":"subspace_op", "sid", "op":"dinf_workload_proof", "e", "re", "p", "account", "allocation_id", "work_units", "score"]                                     |
| 30904      | Settlement Report          | Aggregated settlement instructions or results                       | ["auth", "d":"subspace_op", "sid", "op":"dinf_settlement", "e", "p", "reward_total", "currency", "settlement_ref"]                                                    |
| 30905      | Evaluation / Dispute       | Publish evaluations or disputes for results                         | ["auth", "d":"subspace_op", "sid", "op":"dinf_evaluation", "e", "re", "p", "score", "status"]                                                                         |